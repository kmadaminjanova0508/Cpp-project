//Final_Project_BY_Madaminjanova_Khalima_ 
//NOTE! In this programm I tried to explain it in details 
...
void game()  //function for playing game
{
    ...
    c[2][6] = '>';  //in these coordinates will be our bird, ma
...
void credits()
{
    ...
    {
        cout << "" << endl << endl;
        cout << "               MADE BY : Khalima " << endl << endl;
